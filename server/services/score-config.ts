...
const DEFAULT_SCORE_CONFIG: ScoreConfig = {
  ...
  keywordGen: {
    ...
    banSingles: [
      // ❌ 네이버 광고 금지 키워드 (파워링크 규정)
      "내돈내산", "협찬", "제공받았", "증정", "체험단", "서포터즈", "무료체험", "공짜", 
      "무료지원", "지원받은", "지원받아", "후원받은", "후원받아", "제공받은", "제공받아",
      "스폰서", "스폰", "증정받은", "증정받아", "선물받은", "선물받아",
      
      // ❌ 조회량 0 또는 의미없는 단독 키워드
      "부스터", "사용법", "방법", "이용법", "복용법", "제품", "상품", "브랜드",
      "맛집", "추천", "여자", "남자", "바르", "좋은", "효과", "기능", "특징",
      "장점", "단점", "후기", "리뷰", "평가", "비교", "순위", "랭킹",
      
      // ❌ 일반적 의미없는 키워드 
      "그냥", "진짜", "정말", "완전", "너무", "아주", "매우", "좀", "조금",
      "최고", "최상", "최신", "최적", "베스트", "탑", "인기", "핫", "신상",
      "이것", "저것", "요거", "이런", "저런", "그런"
    ],
    preferCompound: true,
    allowThreeGram: true
